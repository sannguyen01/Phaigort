    ...
    <div>
      <section className="pt-10 md:pt-16 bg-platinum text-royal-navy">
        <Container className="max-w-3xl">
          ...
          <Body className="mt-6 text-royal-navy/70">The profound understanding that exceptional materials spanning geological time, cultural heritage, and human innovation deserve equal reverence. Not a marketing concept but an empirical worldview connecting visible beauty to invisible forces.</Body>
        </Container>
      </section>
      <Divider />
