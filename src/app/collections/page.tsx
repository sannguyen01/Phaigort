      ...
      <section className="pt-10 md:pt-16 bg-platinum text-royal-navy">
        <Container>
          <ScrollReveal>
            ...
            <H1 className="mt-5 max-w-4xl">Comprehensive Material Curation</H1>
            <Body className="mt-6 max-w-2xl text-royal-navy/70">Phaigort curates across four treasure domains without hierarchy. A gemstone formed over millions of years receives the same curatorial reverence as an artisan&apos;s masterwork perfected across generations.</Body>
          </ScrollReveal>
        </Container>
      </section>
      <Divider />
